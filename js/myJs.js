...
function firstQuestion(){
    ...
    $('.content').hide();
    Swal.fire({
        title: 'Helluu Côngg Túaa',
        text: 'Tui có điều này muốn hỏi bạn nhớ phải trả lời thật lòng nhaaa.',
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho tớ lí do cậu thích tớ đi :3',
        html: true,
        width: 900,
        padding: '3em',
        ...
        if (result.value) {
            Swal.fire({
                ...
                onClose: () => {
                    window.location = 'https://www.facebook.com/p.bao0711/';
                  }
            })
        }
    })
